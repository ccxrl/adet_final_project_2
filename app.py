...
# Example error handling and flash message in edit_admission route
...
def edit_admission(admission_id):
    ...
    if request.method == 'POST':
        ...
        # Fetch patient_id associated with this admission detail
        cur.execute("SELECT patient_id FROM admission_details WHERE admission_id = %s", (admission_id,))
        patient_id = cur.fetchone()[0]  # Assuming patient_id is fetched correctly
    ...
    # Fetch admission details for editing
    ...
    # Fetch patient_id associated with this admission detail for rendering edit form
    cur.execute("SELECT patient_id FROM admission_details WHERE admission_id = %s", (admission_id,))
    patient_id = cur.fetchone()[0]  # Assuming patient_id is fetched correctly
